...
},{"./set-browser-class.es6.js":5}],5:[function(require,module,exports){
'use strict';
...
},{"./../models/backgroundMessage.es6.js":1,"./../models/privacy-options.es6.js":2,"./../models/whitelist.es6.js":3,"./../templates/privacy-options.es6.js":7,"./../templates/whitelist.es6.js":9,"./../views/privacy-options.es6.js":10,"./../views/whitelist.es6.js":11,"./mixins/index.es6.js":4}],7:[function(require,module,exports){
'use strict';
...
module.exports = function () {
    return bel(_templateObject, toggleButton(this.model.trackerBlockingEnabled, 'js-options-blocktrackers', 'trackerBlockingEnabled'), toggleButton(this.model.httpsEverywhereEnabled, 'js-options-https-everywhere-enabled', 'httpsEverywhereEnabled'), toggleButton(this.model.embeddedTweetsEnabled, 'js-options-embedded-tweets-enabled', 'embeddedTweetsEnabled'));
};

},{"./shared/toggle-button":8,"bel":12}],8:[function(require,module,exports){
'use strict';
...
},{"bel":12}],9:[function(require,module,exports){
'use strict';
...
},{"bel":12}],10:[function(require,module,exports){
'use strict';
...
Whitelist.prototype = $.extend({}, Parent.prototype, {
    ...
    setup: function setup() {
        ...
        this.bindEvents([[this.$remove, 'click', this._removeItem], [this.store.subscribe, 'change:backgroundMessage', this.update]]);
    },
