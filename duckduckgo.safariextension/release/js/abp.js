...
function updateLists() {
    var _loop = function _loop(list) {
        ...
        load.loadExtensionFile({ url: url, source: 'external', etag: settings.getSetting(list + '-etag') }, function (listData, response) {
